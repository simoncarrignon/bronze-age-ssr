...
source("R/tools.R")
isotopes=read.csv("data/DATA isotopie_Pryce_V4.2.csv")
nolabel=isotopes$LABEL.analytical==""
isotopes$Site.abreviation[isotopes$Site.abreviation==""]="UNK"
isotopes$LABEL.analytical[nolabel]=
    paste("DIV",
          sapply(strsplit(toupper(isotopes$Country[nolabel]),""),function(i)paste0( i[1:2],collapse=""))
                                         ,isotopes$Site.abreviation[nolabel],sep="/")
for(i in unique(isotopes$LABEL.analytical[nolabel])){
    new=isotopes$LABEL.analytical==i
    isotopes$LABEL.analytical[new]=paste0(isotopes$LABEL.analytical[new],"/",1:sum(new))
}

wrongLabels=lengths(strsplit(isotopes$LABEL.analytical,"/"))==1
isotopes$LABEL.analytical[wrongLabels]=
    paste("DIV",
          sapply(strsplit(toupper(isotopes$Country[wrongLabels]),""),function(i)paste0(i[1:2],collapse=""))
                                         ,isotopes$Site.abreviation[wrongLabels],sep="/")
for(i in unique(isotopes$LABEL.analytical[wrongLabels])){
    new=isotopes$LABEL.analytical==i
    isotopes$LABEL.analytical[new]=paste0(isotopes$LABEL.analytical[new],"/",1:sum(new))
}
