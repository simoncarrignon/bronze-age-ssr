...
pryce[,15:19]=apply(pryce[,15:19],2,as.numeric)
pryce=pryce[!is.na(pryce[,15]),]
isotopes=pryce[,15:19]
pryce.pca=prcomp(pryce[,15:19])
...
plot(pryce[,19:18],pch=21,bg=rainbow(10,alpha=.6)[pryce.kclust])
