---
title: "Generate all graph for presentation made in Saclay"
author: "SC"
date: "`r Sys.time()`"
output: 
...
```{r,eval=F}
rmarkdown::render("scriptMeetingWednesday16.Rmd",output_dir="/var/www/html")
``
