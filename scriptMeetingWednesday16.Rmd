...
seashapefile=st_crop(seashapefile,p.sf)
...
seashapefile=st_crop(seashapefile,st_as_sf(as.data.frame(coordsites),coords=1:2,crs=st_crs(seashapefile)))
for(i in 1:4){
